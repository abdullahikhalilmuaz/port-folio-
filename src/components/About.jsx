  ...
  return (
    <div className="about">
      ...
      <p className="about-para">
        ...
        web applications using React.js, Node.js, Express.js, and MongoDB. I'm
        skilled in designing and consuming RESTful APIs, working with TypeScript
        for type-safe development, and using Git and GitHub for version control
        and collaboration. I enjoy building efficient, user-friendly solutions
          ...
          <div className="education-container-wrapper">
            ...
            <div className="education-container">
              ...
              <p className="education-description">
                I am a graduate student of Federal College of Education Katsina,{" "}
                <br />i graduated with upper first class, from department of
                Computer Science
              </p>

              <p className="certification-date" style={{ marginTop: "20px" }}>
                2022
              </p>
        ...
        >
          ...
          >
            ...
            <div className="education-container">
              ...
              <p className="education-description">
                I was selected by Federal College of Education Katsina, <br />
                to build a Unified Digital Hub All Tertiary Institutions accross
                Nigeria.
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="education-container">
              ...
              <p className="education-description">
                I voluntereed to build a fully functional Library Circulation
      ...
      <div className="me-full">
        <div
          ...
          style={{ width: "100%" }}
        >
          <h3 className="education-header">Certifications</h3>
          <div
            className="education-container-wrapper"
            style={{ height: "150px" }}
          >
